        ...
        <div className="sidebar">
            ...
            {chats.map((chat, index) => (
                <div style={{ backgroundColor: idx === index ? '#D3D3D3' : "" }} onClick={() => {
                    ...
                    <img className="delete-chat-button" width={20} height={20} onClick={() => onDeleteChat(index)} src='https://cdn-icons-png.flaticon.com/128/484/484662.png' />
                </div>
            ))}
